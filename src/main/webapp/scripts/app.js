...
var springbootexampleApp = angular.module('springbootexampleApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'springbootexampleAppUtils', 'pascalprecht.translate', 'truncate']);

springbootexampleApp
